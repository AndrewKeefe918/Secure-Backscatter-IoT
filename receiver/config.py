...
BIT_NCC_MARGIN = 0.06          # threshold above tracked noise floor
BIT_NCC_THRESHOLD_MIN = 0.10
BIT_NCC_THRESHOLD_MAX = 0.24
...
NCC_ENTER_THRESHOLD = 0.20  # raised from 0.1 — carrier noise EMA peaks ~0.10–0.15; real signal ~0.5+
NCC_EXIT_THRESHOLD = 0.10   # raised from 0.05 — exit lock promptly when signal drops
NCC_ENTER_FRAMES = 5        # raised from 3 — require sustained detection before locking
NCC_EXIT_FRAMES = 5         # lowered from 8 — don't hold phantom locks too long
